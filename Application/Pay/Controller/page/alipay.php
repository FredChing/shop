<!doctype html>
<html class="no-js">
<head><base href="/Application/Pay/Controller/page/" />
    <meta charset="utf-8">
    ...
    <link rel="stylesheet" href="static/js/assets/css/wx.css">
</head>
<body>
    <header class="alipay">
    ...
    <div class="am-g am-g-fixed am-margin-vertical wx-box">
        <div class="am-u-md-8 am-u-sm-12 am-u-sm-centered am-margin-vertical am-text-center">
            ...
            <div class="am-u-md-8 am-u-sm-12 am-u-sm-centered am-margin-vertical am-text-center">
                <img src="static/js/assets/img/alism.png" alt="请使用支付宝扫描
二维码以完成支付">
            </div>
            <div class="am-u-md-8 am-u-sm-12 am-u-sm-centered am-margin-vertical am-text-center">
                <hr>
 ...
 <script>
		...
		function refresh() {
            ...
            $.ajax({
                url: '/Pay_DmfSm_checkorder.html?orderid=' + orderno,
                type: 'GET',
                cache: false,
                success: function(data) {
					...
					{
						location.href = '/Pay_DmfSm_callbackurl.html?orderid=' + orderno;
