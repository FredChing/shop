...
class DmfH5Controller extends PayController
{
    ...
    public function Pay($array)
    {
        ...
        $notifyurl = $this->_site . 'Pay_DmfH5_notifyurl.html'; //异步通知
        $callbackurl = $this->_site . 'Pay_DmfH5_callbackurl.html'; //返回通知
    ...
    public function callbackurl()
    {
        ...
        if($pay_status <> 0){
            $this->EditMoney($_REQUEST["out_trade_no"], 'DmfH5', 1);
        }else{
            exit("支付完成");
        }
