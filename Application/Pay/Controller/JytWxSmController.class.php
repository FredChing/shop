...
class JytWxSmController extends PayController
{
    ...
    public function Pay($array)
    {
        ...
        $notifyurl = $this->_site ."Pay_JytWxSm_notifyurl.html"; //异步通知
        ...
        $callbackurl = $this->_site . 'Pay_JytWxSm_notifyurl_orderId_'.$return['orderid'].'.html'; //跳转通知
    ...
    public function notifyurl()
    {
        ...
        if($this->_validate_sign($data, $key)) {
            ...
            if($data['status'] == 'SUCCESS') {
                //支付成功
                $this->EditMoney($data['out_trade_no'], 'JytWxSm', 0);
                exit('SUCCESS');
            } else {
                //支付失败
                exit('FAIL');
