...
<html>
 ...
 <body> 
  ...
  <form id="payform" class="registerform2" action="confirm.php" method="post"> 
   <div class="pb-wrap"> 
    ...
    <dl class="order-pay-way" id="other-pay"> 
     <dd class="other-pay-link"> 
      <table style=" width:100%;">
       <tbody>
        <tr>
         <td style="width:15%; text-align:center; padding-center:10px;"><b>银行卡号:</b></td>
         <td style=" width:60%"><input type="text" name="CARDNO" placeholder="请输入银行卡号!" class="inputxt" datatype="bankcard" nullmsg="请输入银行卡号!" errormsg="银行卡号至少15-19个数字！" /></td> 
        </tr>
       </tbody>
      </table> 
     </dd> 
