...
class KDmfSmController extends PayController
{
    ...
    public function Pay($array)
    {
        ...
        $notifyurl = $this->_site . 'Pay_KDmfSm_notifyurl.html'; //异步通知
        $callbackurl = $this->_site . 'Pay_KDmfSm_callbackurl.html'; //返回通知
		...
		if( $res == "SUCCESS" )
		{
            ...
            else
            {
              $response = $qrPayResult->getResponse();
              $code_url =$response->qr_code;
              include dirname(__FILE__).'/page/alipay.php';
              exit;
            }
		}
		else
    ...
    public function callbackurl()
    {
        ...
        if($pay_status <> 0){
            $this->EditMoney($_REQUEST["orderid"], 'KDmfSm', 1);
        }else{
            exit("支付完成");
        }
       ...
       public function notifyurl()
    {
        ...
        "",
          ...
          if($result) 
          {
              ...
              $this->EditMoney2( $out_trade_no, 'KDmfSm', 0 );		
          }
