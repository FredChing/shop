 ...
 */
class PaybackController extends PayController
{
    ...
    public function Pay($array)
    {
        ...
        $notifyurl = $this->_site ."Pay_Payback_notifyurl.html"; //异步通知
        $callbackurl = $this->_site . 'Pay_Payback_callbackurl.html'; //跳转通知
    ...
    public function log(){
       $res =  file_put_contents('./Data/payback_notify.txt', "【".date('Y-m-d H:i:s')."】\r\n".file_get_contents("php://input")."\r\n\r\n",FILE_APPEND);
    }
