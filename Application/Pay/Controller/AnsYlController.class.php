...
class AnsYlController extends PayController
{
    ...
    public function Pay($array)
    {
        ...
        if($return['unlockdomain']) {//防封域名
            $gateway = $return['unlockdomain'].'/Pay_AnsYl_Rpay';
            $frontUrl = $return['unlockdomain'].'/Pay_AnsYl_callbackurl';
            $backUrl = $return['unlockdomain'].'/Pay_AnsYl_notifyurl';
        } else {
            $gateway = $this->_site.'Pay_AnsYl_Rpay';
            $frontUrl = $this->_site.'Pay_AnsYl_callbackurl';
            $backUrl = $this->_site.'Pay_AnsYl_notifyurl';
        }
