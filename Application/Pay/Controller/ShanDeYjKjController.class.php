...
class ShanDeYjKjController extends PayController
{

    protected $gateway = 'https://cashier.sandpay.com.cn/fastPay/quickPay/index';
    ...
    public function Pay($array)
    {
        ...
        $data    = $this->getParameter('杉德(一键快捷)', $array, __CLASS__, 100);
        //获取私钥，公钥
        ...
        $jsonData = [
            ...
            'body' => [
                'userId'       => (string)date('d').substr(microtime(), 3, 2).date('His'),
                ...
                'frontUrl'     => $this->_site . 'Pay_ShanDeYjKj_callbackurl_orderid_'.$data['orderid'].'.html',
                'clearCycle'   => '0',
                'extend'       => '',
            ],
        ];
        ...
        echo $this->createForm($this->gateway, $params);
    }
