...
class DmfSmController extends PayController
{
    ...
    public function Pay($array)
    {
        ...
        $notifyurl = $this->_site . 'Pay_DmfSm_notifyurl.html'; //异步通知
        $callbackurl = $this->_site . 'Pay_DmfSm_callbackurl.html'; //返回通知
    ...
    public function callbackurl()
    {
        ...
        if($pay_status <> 0){
            $this->EditMoney($_REQUEST["orderid"], 'DmfSm', 1);
        }else{
            exit("支付完成");
        }
       ...
       public function notifyurl()
    {
        ...
        "",
          ...
          if($result) 
          {
              ...
              $this->EditMoney( $out_trade_no, 'DmfSm', 0 );		
          }
